...
export default function CookieConsent() {
  ...
  return (
    <div className="fixed bottom-6 left-1/2 transform -translate-x-1/2 z-50 w-full max-w-3xl bg-white border-t-4 border-teal-500 rounded-md shadow-xl px-6 py-5">
      {/* Header */}
